   ...
   private final static String EMAIL_PATTERN = "^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$";
	...
	public void validate(FacesContext fc, UIComponent c, Object o) throws ValidatorException {
		...
		if (o == null || "".equals((String)o)) {
			FacesMessage msg = new FacesMessage("Pas d'adresse email", "Email Validation Error");
		...
		if (!matcher.matches()) {	// Email doesn't match
			FacesMessage msg = new FacesMessage("Adresse email invalide!", "Email Validation Error");
			msg.setSeverity(FacesMessage.SEVERITY_ERROR);
			throw new ValidatorException(msg);
		}
